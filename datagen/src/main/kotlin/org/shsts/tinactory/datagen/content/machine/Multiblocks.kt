...
object Multiblocks {
    ...
    private fun components() {
        blockData {
            ...
            misc("clear_glass") {
                blockState { ctx ->
                    solidBlockCtm(ctx, modLoc("block/multiblock/glass/quartz_glass_a"), Models.CUTOUT_RENDER_TYPE)
                }
                tag(CLEANROOM_WALL)
            ...
            misc("fusion_glass") {
                blockState(solidBlockCtm("casings/transparent/fusion_glass", Models.CUTOUT_RENDER_TYPE))
                tag(FUSION_SHELL)
            }
