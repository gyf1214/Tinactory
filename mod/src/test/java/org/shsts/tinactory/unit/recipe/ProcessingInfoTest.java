...
class ProcessingInfoTest {
    ...
    void shouldRoundTripIngredientInfoThroughInjectedCodec() {
        ...
        var tag = CodecHelper.encodeTag(EMPTY_REGISTRY, INFO_CODEC, info);
        var roundTrip = CodecHelper.parseTag(EMPTY_REGISTRY, INFO_CODEC, tag);
    ...
    void shouldRejectInvalidTagsWithoutIngredientOrResult() {
        ...
        assertThrows(RuntimeException.class, () -> CodecHelper.parseTag(EMPTY_REGISTRY, INFO_CODEC, tag));
    }
}
