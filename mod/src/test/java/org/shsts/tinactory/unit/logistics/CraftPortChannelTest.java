...
class CraftPortChannelTest {
    ...
    void extractShouldSupportAmountsLargerThanIntegerMaxValue() {
        ...
        var channel = new CraftPortChannel<>(TestStack.ADAPTER, port);
        var key = TestStack.ADAPTER.keyOf(new TestStack("iron", 1));
    ...
    void snapshotShouldMapPortStorageWithCraftKeys() {
        ...
        assertEquals(List.of(new CraftAmount(TestStack.ADAPTER.keyOf(new TestStack("iron", 1)), 7)), snapshot);
    }
