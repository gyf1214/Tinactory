...
public record OutputPortConstraint(int outputSlotIndex, @Nullable Integer portIndex, @Nullable Direction direction)
    ...
    public static final Codec<OutputPortConstraint> CODEC = Codec.STRING.xmap(
        OutputPortConstraint::decode,
        OutputPortConstraint::encode
    );
    ...
    private static String encode(OutputPortConstraint constraint) {
    ...
    private static OutputPortConstraint decode(String payload) {
