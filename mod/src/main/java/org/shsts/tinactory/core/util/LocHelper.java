...
public final class LocHelper {
    ...
    public static ResourceLocation modLoc(String id) {
        return ResourceLocation.fromNamespaceAndPath(TinactoryKeys.ID, id);
    }

    public static ResourceLocation gregtech(String id) {
        return ResourceLocation.fromNamespaceAndPath("gregtech", id);
    }

    public static ResourceLocation ae2(String id) {
        return ResourceLocation.fromNamespaceAndPath("appliedenergistics2", id);
    }

    public static ResourceLocation ic2(String id) {
        return ResourceLocation.fromNamespaceAndPath("ic2", id);
    }
