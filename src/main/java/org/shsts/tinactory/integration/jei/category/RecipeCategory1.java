...
public abstract class RecipeCategory1<T extends SmartRecipe<?>, M extends AbstractContainerMenu> {
    ...
    protected RecipeCategory1(RecipeTypeEntry<? extends T, ?> recipeType, Layout layout, Ingredient catalyst,
    ...
    protected void drawExtra(T recipe, ICategoryDrawHelper helper, IRecipeSlotsView recipeSlotsView,
    ...
    private class Category implements IRecipeCategory<T>, ICategoryDrawHelper {
        ...
        public void setRecipe(IRecipeLayoutBuilder builder, T recipe, IFocusGroup focuses) {
            ...
            RecipeCategory1.this.setRecipe(recipe, ingredientBuilder);
    ...
    private class TransferInfo implements IRecipeTransferInfo<M, T> {
        ...
        public List<Slot> getInventorySlots(M container, T recipe) {
            return RecipeCategory1.this.getInventorySlots(container);
        }
