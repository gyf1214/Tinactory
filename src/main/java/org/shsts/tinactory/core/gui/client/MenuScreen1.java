...
public class MenuScreen1<M extends Menu<?, M>> extends AbstractContainerScreen<M>
    implements IMenuScreen, IWidgetConsumer {
    public static final Texture BACKGROUND = new Texture(gregtech("gui/base/background"), WIDTH, 166);

    protected final Panel rootPanel;
    protected final List<Widget> hoverables = new ArrayList<>();

    public MenuScreen1(M menu, Inventory inventory, Component title) {
