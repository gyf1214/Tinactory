...
public final class AllNetworks {
    ...
    static {
        ...
        ELECTRIC_COMPONENT = _REGISTRATE.componentType("electric", ElectricComponent.class, ElectricComponent::new);
        LOGISTIC_COMPONENT = _REGISTRATE.componentType("logistics", LogisticComponent.class, LogisticComponent::new);
    }
