...
import static org.shsts.tinactory.content.machine.ElectricStorage.GLOBAL_KEY;
import static org.shsts.tinactory.content.machine.ElectricStorage.STORAGE_KEY;
import static org.shsts.tinactory.content.machine.ElectricStorage.UNLOCK_KEY;
...
public class ElectricStorageScreen<M extends ElectricStorageMenu> extends LayoutScreen<M> {
    public ElectricStorageScreen(M menu, Component title) {
        ...
        addWidget(anchor, offset, new MachineConfigButton(menu, config, UNLOCK_KEY, false,
        ...
        addWidget(anchor, offset.enlarge(2, 2).offset(-1, -1),
            new MachineConfigButton(menu, config, STORAGE_KEY, true,
                ALLOW_ARROW_BUTTON, 0, 20, "chestNotStorage", "chestStorage"));
        offset = offset.offset(-SLOT_SIZE - SPACING, 0);
        addWidget(anchor, offset, new MachineConfigButton(menu, config, GLOBAL_KEY, false,
