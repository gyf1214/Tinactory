...
public final class Materials {
    public static void init() {
        FACTORY.material(IRON, METALLIC)
                ...
                .toolProcess()
                .build()
                .material(CHALCOPYRITE, DULL).smelt(COPPER).build()
                .material(PYRITE, ROUGH).smelt(IRON).build()
                .material(LIMONITE, METALLIC).smelt(IRON).build()
                .material(BANDED_IRON, DULL).smelt(IRON).build()
                .material(COAL, DULL).build()
                .material(CASSITERITE, METALLIC).smelt(TIN).build()
                .material(REDSTONE, DULL).build()
                .material(CINNABAR, SHINY).build()
                .material(RUBY, IconSet.RUBY).build()
                .material(MAGNETITE, METALLIC).smelt(IRON).build()
